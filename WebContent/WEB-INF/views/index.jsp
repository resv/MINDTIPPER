...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
  <div class="container">
    <a class="navbar-brand btn js-scroll-trigger" href="GO TO HOMEEEEEPAGEEEEE">Mind Tipper</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="#GO TO NEW DECISION PAGGGGGGGGGGGE">New Decision</a>
        </li>
        <li class="nav-item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-9 mx-auto">                 
            ...
            <a href="GOO TOOOO SIGNNNNNNNN INN" class="btn btn-primary js-scroll-trigger animated wow fadeInDown" id="landing4">Get Started</a>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="testimonial-item mx-auto mb-5 mb-lg-0">
              ...
              <p class="font-weight-light mb-0 animated wow fadeInDown" id="motto1">"Building Careers.
