...
<div class="col-md-12" style="padding: 7rem 0rem 1rem; height: auto;">
    <h1 class="display-1 text-center">TERMS OF USE</h1>
...
<h3 class="text-center">AGREEMENT TO TERMS</h3>
<br>
<div>
    These Terms of Use constitute a legally binding agreement made between you, whether personally or on
    behalf of an entity ("you") and Mind Tipper ("Company", "we",
    "us", or "our"), concerning your access to
    and use of the www.MindTipper.com website as well as any other media form, media channel, mobile website or
    mobile application related, linked, or otherwise connected thereto (collectively, the
    "Site"). You agree that by accessing the Site, you have read, understood, and agreed to be
    ...
    about any changes by updating the "Last updated" date of these Terms of Use, and you waive
...
<div>
    ...
    of the United States, foreign jurisdictions, and international conventions. The Content and the Marks
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">USER REPRESENTATIONS</h3>
<br>
<div>
    ...
    reside; (3) you will not access the Site through automated or non-human means, whether through a
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">PROHIBITED ACTIVITIES</h3>
<br>
<div>
    ...
    <br><br>
    <p class="text-center" style="font-weight: bold">As a user of the Site, you agree not to:</p>
</div>
</div>
<hr>
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">SITE MANAGEMENT</h3>
<br>
<div>
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">TERM AND TERMINATION</h3>
<br>
<div>
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">MODIFICATIONS AND INTERRUPTIONS</h3>
<br>
<div>
...
<div>
    ...
    the State of New York applicable to agreements made and to be entirely performed withinthe State of
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">DISPUTE RESOLUTION</h3>
<br>
<div>
    <p class="text-center" style="font-weight: bold">Binding Arbitration</p>
    ...
    AAA's Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of
    which are available at the AAA website www.adr.org. Your arbitration fees and your share of
    arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited
    by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of
    ...
    in Queens County, New York. Except as otherwise provided herein, the Parties may litigate in
    ...
    commenced or prosecuted in the state and federal courts located in Queens County, New York,
    ...
    of Goods and the the Uniform Computer Information Transaction Act (UCITA) are excluded from these
    Terms of Use.
    <br><br>
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">EXCEPTIONS OF ARBITRATION</h3>
<br>
<div>
    The Parties agree that the following Disputes are not subject to the above provisions concerning
    binding arbitration: (a) any Disputes seeking to enforce or protect, or concerning the validity of, any
    of the intellectual property rights of a Party; (b) any Dispute related to, or arising from,
...
<div>
    ...
    WHATSOEVER, RESULTING FROM YOUR ACCESS TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">LIMITATIONS OF LIABILITY</h3>
<br>
<div>
    ...
    BE LIMITED TO THE LESSER OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR __________. CERTAIN STATE LAWS DO NOT
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
<br>
<div>
...
<div class="col-md-12" style="padding: 1rem 0rem 1rem; height: auto;">
<h3 class="text-center">CALIFORNIA USERS AND RESIDENTS</h3>
<br>
<div>
...
<div>
    ...
    that these Terms of Use will not be construed against us by virtue of having drafted them. You hereby waive
    any and all defenses you may have based on the electronic form of these Terms of Use and the lack of
...
<div>
    ...
    Site, please contact us at: Support@MindTipper.com
</div>
</div>
